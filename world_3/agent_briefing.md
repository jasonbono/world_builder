...
- `command` — the command to run it (e.g. `"python3 world_3/run_1/solvers/solve_goal1.py"`)
- `report` — your full report markdown

## Goal 1 (action)

Reach x = 50.0 (±0) at t = 9. You may experiment freely, but when you execute your solution (after your final `/reset`), you may call `/act` at most once.
